<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="DetallePersona.aspx.cs" Inherits="CrudApp.Paginas.DetallePersona" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="mx-auto" style="width: 250px">
        <asp:Label runat="server" CssClass="h2" ID="lbltitulo">Detalle Persona</asp:Label>
    </div>
        <br />
